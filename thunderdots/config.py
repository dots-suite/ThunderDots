...
class ThunderDotsConfig:
    ...
    fetch_collection_metadata: bool = True # whether to fetch metadata for collections (can be skipped if only ids are needed)
    fetch_resource_metadata: bool = True # whether to fetch metadata for resources (can be skipped if only ids are needed)
    collection_params: CollectionParams = field(default_factory=CollectionParams) # parameters for collection fetching/filtering
    resource_params: ResourceParams = field(default_factory=ResourceParams) # parameters for resource fetching/filtering
    verbose: bool = True
    ...
    go_lib_path: str | None = None # path to the Go fetcher shared library (e.g. "native/build/libthunderdots.dylib"), required if fetcher is "go"
    ...
    output_path: str | None = None # path to save the final output JSON (e.g. "output/results.json"), optional
